<template>
    <div>
        <Col span="12">
            <Card style="margin:20px 0 0 20px">
                ...
                <Carousel
                    ...
                    :arrow="setting.arrow">
                    <CarouselItem>
                        <div class="demo-carousel blue">1</div>
                    </CarouselItem>
                    <CarouselItem>
                        <div class="demo-carousel red">2</div>
                    </CarouselItem>
                    <CarouselItem>
                        <div class="demo-carousel green">3</div>
                    </CarouselItem>
                    <CarouselItem>
                        <div class="demo-carousel yellow">4</div>
                    </CarouselItem>
                </Carousel>
            </Card>
        </Col>
        <Col span="12">
            <Card style="margin:20px 0 0 20px">
                <Affix :offset-top="0" @on-change="change">
                    <span class="demo-affix" style="display:inlineBlock;background:rgba(0,153,229,.9);padding:10px 30px">滚动固定在顶部</span>
                </Affix>
                ...
                <Panel name="2">
                    运行策略
                    <p slot="content">冷机室内负荷反馈控制冷机室内负荷反馈控制冷机室内负荷反馈控制冷机室内负荷反馈控制冷机室内负荷反馈控制冷机室内负荷反馈控制冷机室内负荷反馈控制冷机室内负荷反馈控制冷机室内负荷反馈控制冷机室内负荷反馈控制冷机室内负荷反馈控制</p>
                </Panel>
                <Panel name="1">
                    故障报警
                    <p slot="content">无</p>
